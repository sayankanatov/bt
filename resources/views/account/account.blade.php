...
<div class="col-md-12">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="btn btn-success btn-lg" style="margin-left: 10%;" href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().$kindergarten_link)}}">@lang('messages.kindergarten_link')</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-warning btn-lg" style="margin-left: 15%;" href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().$report_link)}}">@lang('messages.reports')</a>
            </li>
        </ul>
