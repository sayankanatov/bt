...
@endif
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="btn btn-success btn-lg" style="margin-left: 15%;" href="{{$groups_link}}">@lang('messages.groups')</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-warning btn-lg" style="margin-left: 15%;" href="{{$user_base_link}}">@lang('messages.users')</a>
            </li>
        </ul>
    </div>
</nav>
