...
<div class="col-md-6">
	<form role="form" action="{{action('ClientController@updateContractor',['id' => $contractor->id])}}" method="post">
		@csrf
		...
		<a href="{{url(App\Http\Middleware\LocaleMiddleware::getLocale().'/user/pp')}}" class="btn btn-secondary">
			@lang('messages.back')
		</a>
	</form>
</div>
