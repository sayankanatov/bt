...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="btn btn-success" href="{{url('/account/kindergarten')}}">@lang('messages.kindergarten_link')</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-warning" href="{{url('/account/report')}}">@lang('messages.reports')</a>
            </li>
        </ul>
